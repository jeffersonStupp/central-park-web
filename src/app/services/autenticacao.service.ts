...
export class AutenticacaoService {
  ...
  constructor(public httpClient: HttpClient, public readonly router: Router) {}
  ...
  public estaLogado(): boolean {
    ...
    return (
      tokenStorage != null &&
      tokenStorage != '' &&
      this.dataExpiracaoTokenMaiorQueAgora()
    );
  }

  public dataExpiracaoTokenMaiorQueAgora(): boolean {
    const dataExpiracaoToken = localStorage.getItem(
  ...
  public tipoPerfilEhAdmin(): boolean {
    return (
      localStorage.getItem(this.chaveLocalStorageTipoPerfil) == 'administrador'
    );
  }
